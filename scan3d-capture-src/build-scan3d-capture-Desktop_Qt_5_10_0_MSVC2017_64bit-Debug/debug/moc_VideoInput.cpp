...
struct qt_meta_stringdata_VideoInput_t {
    QByteArrayData data[5];
    char stringdata0[36];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_VideoInput_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_VideoInput_t qt_meta_stringdata_VideoInput = {
    {
QT_MOC_LITERAL(0, 0, 10), // "VideoInput"
QT_MOC_LITERAL(1, 11, 9), // "new_image"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 7), // "cv::Mat"
QT_MOC_LITERAL(4, 30, 5) // "image"

    },
    "VideoInput\0new_image\0\0cv::Mat\0image"
};
...
void VideoInput::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (VideoInput::*_t)(cv::Mat );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&VideoInput::new_image)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject VideoInput::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_VideoInput.data,
      qt_meta_data_VideoInput,  qt_static_metacall, nullptr, nullptr}
};
...
void *VideoInput::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_VideoInput.stringdata0))
